...
# " [#number](https://github.com/affinehealth/affine-foundry/issues/<number>)
...
# Example:
#
# $ ./scripts/linkify.py CHANGELOG.md
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s#([0-9]+)", r" [#\1](https://github.com/affinehealth/affine-foundry/issues/\1)", line.rstrip())
    print(line)
